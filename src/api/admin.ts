...
export async function updateProfile(role: AdminRole, data: { name?: string; phone?: string; email?: string; whatsapp_number?: string; main_balance?: string }) {
...
export async function createPromotion(body: { title: string; description?: string; cta_label?: string; cta_link?: string; is_active?: boolean; order?: number }) {
  return apiPost(`${prefix("powerhouse")}/promotions/`, body);
}
export async function updatePromotion(id: number, body: Partial<{ title: string; description: string; cta_label: string; cta_link: string; is_active: boolean; order: number }>) {
...
export async function createComingSoon(body: { name: string; description?: string; coming_date?: string | null; is_active?: boolean; order?: number }) {
  return apiPost(`${prefix("powerhouse")}/coming-soon/`, body);
}
export async function updateComingSoon(id: number, body: Partial<{ name: string; description: string; coming_date: string | null; is_active: boolean; order: number }>) {
