...
type GameLogRow = Record<string, unknown> & { user_username?: string; game_name?: string; category?: string; bet_amount?: string; result?: string; win_amount?: string; created_at?: string };
...
const AdminGameLog = () => {
  ...
  const columns = [
    ...
    { header: "Result", accessor: (row: GameLogRow) => <StatusBadge status={String(row.result ?? "")} /> },
