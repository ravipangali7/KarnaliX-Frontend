            ...
            <div className="md:col-span-2 space-y-2 pt-1 border-t border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                  ...
                  <PasswordInput placeholder="API secret" value={apiSecret} onChange={(e) => setApiSecret(e.target.value)} autoComplete="off" />
                </div>
                <div>
                  <label className="text-xs text-muted-foreground block mb-1">API token (optional)</label>
                  <PasswordInput placeholder="API token" value={apiToken} onChange={(e) => setApiToken(e.target.value)} autoComplete="off" />
                </div>
              </div>
            </div>
            <div>
