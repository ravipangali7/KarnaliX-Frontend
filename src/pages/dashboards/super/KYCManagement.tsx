...
export const KYCManagement: React.FC = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await apiClient.getSuperKYC();
  ...
  const handleApprove = async () => {
    ...
    try {
      await apiClient.approveSuperKYC(selectedKYC.id);
  ...
  const handleReject = async () => {
    ...
    setActionLoading(true);
    try {
      await apiClient.rejectSuperKYC(selectedKYC.id, { remarks: rejectReason });
      ...
      >
        {selectedKYC && (
          <div className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-gray-700 rounded-lg flex flex-col items-center justify-center min-h-[120px]">
                {selectedKYC.document_front ? (
                  <img src={selectedKYC.document_front} alt="Front" className="max-h-[150px] object-contain rounded" />
                ) : (
              ...
              <div className="p-4 bg-gray-700 rounded-lg flex flex-col items-center justify-center min-h-[120px]">
                {selectedKYC.document_back ? (
                  <img src={selectedKYC.document_back} alt="Back" className="max-h-[150px] object-contain rounded" />
                ) : (
                  <FileText className="h-12 w-12 text-gray-500" />
                )}
        ...
        <div className="space-y-4 py-4">
          {actionType === 'approve' ? (
            ...
            <div className="space-y-4">
              <p className="text-gray-300">Provide a reason for rejection:</p>
              <Textarea
                value={rejectReason}
          ...
          <div className="flex gap-3 pt-4">
            <Button variant="outline" onClick={() => setConfirmOpen(false)} className="flex-1 border-gray-600 text-gray-300">
              Cancel
            </Button>
            <Button
