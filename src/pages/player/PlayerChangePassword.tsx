      ...
      <Card className="gaming-card">
        <CardContent className="p-5 space-y-4">
          ...
          <div>
            ...
            <PasswordInput placeholder="Enter new password" value={newPw} onChange={(e) => setNewPw(e.target.value)} className="h-11" autoComplete="new-password" />
            {newPw && (
          ...
          <div>
            ...
            <PasswordInput placeholder="Confirm new password" value={confirm} onChange={(e) => setConfirm(e.target.value)} className="h-11" autoComplete="new-password" />
            {confirm && newPw && (
