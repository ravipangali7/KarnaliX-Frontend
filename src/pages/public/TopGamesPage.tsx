  ...
  return (
    <div className="container px-2 mobile:px-4 py-4 mobile:py-6 space-y-4 min-w-0 max-w-full">
      <div className="min-w-0">
        <h1 className="font-gaming font-bold text-xl mobile:text-2xl neon-text tracking-wide truncate">TOP GAMES</h1>
        <p className="text-xs mobile:text-sm text-muted-foreground mt-1 truncate">Hand-picked top picks for you</p>
      </div>
